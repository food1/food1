...
<script src="/jp/build/flexible_css.debug.js"></script>
<script src="/jp/build/flexible.debug.js"></script>
<script src="/jp/build/makegrid.debug.js"></script>

<link href="/jp/css/style.css" rel="stylesheet" />

<script src="/jp/js/jquery.min.js"></script>
<script src="/jp/js/awardRotate.js"></script>
...
<div class="TurntablePage" style="padding-top: 50px;">
	<div class="TurntableBox" style="display: none;">
		...
		<div class="turnplate">
			...
			<img class="pointer" src="/jp/images/start.png">
		</div>
	</div>
	<div class="editBox">
		<a href="javascript:;" class="editBtn">开始吧</a>
		<a href="#" onClick="javaScript:history.go(-1)" class="editBtn">不用了</a>
	</div>
	<div class="warning">
		别犹豫，我来帮你做决定
	</div>
	<div class="editContent">
		<h1>请输入主题</h1>
		<div class="title">
			<input type="text" id="title" value="今天吃点啥">
			<a href="javascript:;" class="delete"></a>
		</div>
		<h1>请输入选项（最少2组）</h1>
		<div class="optionBox">
			<div class="options"><input type="text" placeholder="我帮你选(最多五个字符)"  /><a href="javascript:;" class="delete"></a> </div>
			<div class="options"><input type="text" placeholder="我帮你选(最多五个字符)"  /><a href="javascript:;" class="delete"></a> </div>
		</div>
		<div class="btns">
