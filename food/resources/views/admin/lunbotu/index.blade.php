...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><span><img src="/admingg/images/t01.png" /><a href="/lunbotu/create"></span>添加</a></li>
        </ul>
    ...
    <table class="tablelist">
        ...
        <td>{{$v['id']}}</td>
        <td><img src="{{$v['lunbo_pic']}}" width="50" height="50"></td>
        <td><a href="/lunbotu/{{$v['id']}}/edit" class="tablelink">编辑</a>
            <form style="float: left" action="/lunbotu/{{$v['id']}}" method="post">
            {{method_field('DELETE')}}
            {{csrf_field()}}
            <button href="/lunbotu/{{$v['id']}}" class="tablelink"> 删除</button>
            </form>
        </td>
        </tr>
           @endforeach    
